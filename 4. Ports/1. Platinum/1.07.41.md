...
![](https://xyinn.org/diablo/platforms/platinum/1.07.41/screenshots/Screenshot001.jpg)
...
- [**Download Now**](https://xyinn.org/diablo/platforms/platinum/1.07.41/)

This platform provides the 1.07.41 Beta for Diablo II LOD. This was only
available to a small amount of beta testers and was online only. GalaXyHaXz
was able to successfully unlock and restore the 1.07.41 Beta to allow it to
work for Offline Single Player. For the record, from what we understand, the
official 1.07 retail release of LOD was actually the 1.07.44 Beta.

**NOTE:** These files are from my archived 1.07.41 copy, it should be the original
files distributed by GalaXyHaXz without any of my modifications. Let me know if
this is incorrect and we can update the files to correct any discrepencies.
...
- Add an entry to Cactus called **`1.07.41`** that launches **`Game.exe`**.
...
- [Diablo II Beta & LOD Beta Images Post](https://www.betaarchive.com/forum/viewtopic.php?t=35744)

## Screenshots

![](https://xyinn.org/diablo/platforms/platinum/1.07.41/screenshots/Screenshot002.jpg)
![](https://xyinn.org/diablo/platforms/platinum/1.07.41/screenshots/Screenshot003.jpg)
