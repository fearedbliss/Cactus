...
versions **`1.00 - 1.13d`**. Furthermore, **`Diablo II: Resurrected`** 
is based on **`1.14d`**, thus you can use that for future game updates 
from Blizzard. 
...
**`1.14d+`**, please download **`glidewrapper`** or an alternative video 
...
- Both **`Glide`** and **`DirectDraw`** have this problem, however the problem
  ...
  Singling includes the [Scrolling Letters Fix](https://odysee.com/@TheCactusSanctuary:f/4_-Diablo-II--Scrolling-Letters-Fix---Demo-%28Included-in-Singling_Cactus%29-SzzfbICGPJ4:8)
